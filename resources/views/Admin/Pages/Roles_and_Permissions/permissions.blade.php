                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="text-center">
                                 <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#update_permission">
...
<!-- Add Dialog -->
<div class="modal fade" id="add_permission" data-backdrop="static">
            ...
            <form action="">
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <input type="text" class="form-control" name="u_permission" id="u_permission">
                  </div>
               </div>
            </form>
         </div>
